...
const UserAdd: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl mx-auto py-4 animate-fade-in">
      {/* Page Heading */}
      <div className="flex flex-wrap justify-between items-start gap-4 pb-6 border-b border-gray-200 dark:border-slate-700">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Adicionar Novo Usuário</h1>
      ...
      <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 md:p-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <label className="flex flex-col gap-2 group">
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400 group-focus-within:text-primary-600 transition-colors">Nome Completo</span>
                <div className="relative">
                  <input 
                    className="w-full rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:border-primary-600 focus:ring-1 focus:ring-primary-600 h-12 px-4 outline-none transition-all" 
          ...
          <div className="flex flex-col gap-6 pt-6 border-t border-gray-100 dark:border-slate-700">
            <h3 className="text-lg font-semibold text-slate-800 dark:text-white flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <label className="flex flex-col gap-2 group">
                ...
                <div className="relative">
                  <select className="w-full appearance-none rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:border-primary-600 focus:ring-1 focus:ring-primary-600 h-12 px-4 pr-10 outline-none transition-all cursor-pointer">
        ...
        {/* Form Actions */}
        <div className="bg-gray-50 dark:bg-slate-900/50 px-6 py-4 md:px-8 border-t border-gray-200 dark:border-slate-700 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="h-10 px-6 rounded-lg border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-white text-sm font-medium hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              Cancelar
            </button>
